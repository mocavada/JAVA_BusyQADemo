...
import com.busyqa.project.jobbank.repo.JobCompanyRepository;
import com.busyqa.project.jobbank.repo.JobPostUserRepository;
...
public class JobbankService {
    ...
    @Autowired
    private JobCompanyRepository jbCompanyRepository;
    @Autowired
    ...
    public JobbankService(JobCompanyRepository jbCompanyRepository,
        ...
        this.jbCompanyRepository = jbCompanyRepository;
...
//        this.jbCompanyRepository.findFirst1ByCompanyName(jobCompany.getCompanyName());
        JobCompany jobCompanySaved = this.jbCompanyRepository.save(jobCompany);
